...
const messages = {
  en: {
    ...
    error: {
      ...
      equip415: '这种东西能装备吗……',
      equip500: '装备异常，请稍后重试',
      endWork500: '因为一些神秘的原因，这份工作暂时无法结束，稍后再试',
      endWork413: '您无法缴纳足够的赔偿金',
      goods404: '这种商品已被移出游戏',
      job403: '招聘简章已失效',
    ...
    goodsName: {
      ...
      stoneDagger: '岩剑',
      stoneShield: '岩盾',
      copperDaggerBroken: '残破铜剑',
      copperDaggerOld: '旧铜剑',
      copperShieldOld: '旧铜盾',
      skinSack: '皮质兜袋',
      skinKnapsack: '皮质背包',
      skinKnapsackBig: '皮质背包(大)',
      milk: '牛奶',
      log: '原木',
      leaves: '树叶',
      wheat: '小麦',
    ...
    outskirts: {
      ...
      attack: '你正面强攻，给{monster}造成 <strong style="color: #d15000">{attack}</strong> 点伤害。',
      gbh0: '敌人站立不稳之际，你瞄准了对方的关节，对{monster}造成 <strong style="color: #d10000">{attack}</strong> 点伤害。',
      gbh1: '{monster}恼火的冲你扑来，你瞄准它的弱点部位顺势一击，造成 <strong style="color: #d10000">{attack}</strong> 点伤害。',
      ...
      nimble0: '{self}势大力沉的攻向敌人，谁曾想<strong style="color: #d10000">{target}</strong>一转身形，避开了这一击。',
      nimble1: '{self}的攻击将要出手，却意外的一个晃神，竟被<strong style="color: #d10000">{target}</strong>躲开了。',
      nimble2: '<strong style="color: #d10000">{target}</strong>突然摇晃身形，躲掉了{self}的随手一击。',
      homeTarget: '回城方向',
      knapsack: '背包',
      map: '地图',
      runaway: '逃跑',
    ...
    work: {
      ...
      selfPublish: '我发布',
      nowWork: '{money}铜币/小时，剩余 {min} 分 {sec} 秒',
      zeroJob: '本地暂无工作岗位',
